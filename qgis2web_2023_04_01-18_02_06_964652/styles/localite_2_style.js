var size = 0;
var placement = 'point';
function categories_localite_2(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'CL_ARRONDISSEMENT':
...
var style_localite_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("statut_adm");
    var labelText = "";
    size = 0;
...
var style = categories_localite_2(feature, value, size, resolution, labelText,
