...
function categories_route_5(feature, value, size, resolution, labelText,
        ...
        stroke: new ol.style.Stroke({color: 'rgba(253,7,18,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0}),
...
case 'PAVE':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(253,163,18,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
